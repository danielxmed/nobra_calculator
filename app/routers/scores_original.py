...
@router.post("/curb_65", response_model=Curb65Response, summary="Calculate CURB-65 Score", description="Assesses pneumonia severity using the CURB-65 score", response_description="Pneumonia severity assessment with treatment recommendations", operation_id="curb_65")
...
@router.post("/abcd2_score", response_model=Abcd2Response, summary="Calculate ABCD² Score", description="Estimates stroke risk after TIA", response_description="Stroke risk stratification", operation_id="abcd2_score")
...
@router.post("/4ts_hit", response_model=FourTsResponse, summary="Calculate 4Ts Score", description="Assesses HIT probability", response_description="Probability of heparin-induced thrombocytopenia", operation_id="4ts_hit")
...
@router.post("/aims", response_model=AimsResponse, summary="Calculate AIMS", description="Assesses tardive dyskinesia", response_description="Tardive dyskinesia assessment", operation_id="aims")
...
@router.post("/4c_mortality_covid19", response_model=FourCMortalityResponse, summary="Calculate 4C Mortality Score", description="Estimates COVID-19 hospital mortality risk", response_description="Hospital mortality risk stratification", operation_id="4c_mortality_covid19")
...
@router.post("/6_minute_walk_distance", response_model=SixMinuteWalkResponse, summary="Calculate 6 Minute Walk Distance", description="Estimates functional capacity", response_description="Predicted distance and functional capacity analysis", operation_id="6_minute_walk_distance" )
...
@router.post("/a_a_o2_gradient", response_model=AAO2GradientResponse, summary="Calculate A-a O₂ Gradient", description="Estimates alveolar-arterial oxygen gradient", response_description="A-a gradient and interpretation of lung function", operation_id="a_a_o2_gradient")
...
@router.post("/aas", response_model=AasResponse, summary="Calculate AAS", description="Assesses domestic violence", response_description="Domestic violence screening", operation_id="aas")
...
@router.post("/aap_pediatric_hypertension", response_model=AapPediatricHypertensionResponse, summary="Calculate AAP Pediatric Hypertension", description="Classifies pediatric blood pressure", response_description="Pediatric BP classification", operation_id="aap_pediatric_hypertension")
...
@router.post("/abbey_pain_scale", response_model=AbbeyPainResponse, summary="Calculate Abbey Pain Scale", description="Assesses pain intensity in dementia", response_description="Pain intensity and recommendations", operation_id="abbey_pain_scale")
...
@router.post("/abic_score", response_model=AbicScoreResponse, summary="Calculate ABIC Score", description="Estimates survival prognosis for alcoholic hepatitis", response_description="Survival prognosis", operation_id="abic_score")
...
@router.post("/alc", response_model=AlcResponse, summary="Calculate ALC", description="Assesses alcohol consumption", response_description="Alcohol consumption assessment", operation_id="alc")
...
@router.post("/anc", response_model=AncResponse, summary="Calculate ANC", description="Assesses anemia severity", response_description="Anemia severity assessment", operation_id="anc")
...
@router.post("/acc_aha_hf_staging", response_model=AccAhaHfStagingResponse, summary="Calculate ACC AHA HF Staging", description="Stages heart failure severity", response_description="Heart failure severity staging", operation_id="acc_aha_hf_staging")
...
@router.post("/eular_acr_2012_pmr", response_model=EularAcrPmrResponse, summary="Calculate EULAR ACR 2012 PMR", description="Estimates renal function in patients with rheumatoid arthritis", response_description="EULAR ACR 2012 PMR", operation_id="eular_acr_2012_pmr")
...
@router.post("/four_at", response_model=FourAtResponse, summary="Calculate 4AT", description="Assesses atrial fibrillation", response_description="Atrial fibrillation assessment", operation_id="four_at")
...
@router.post("/helps2b", response_model=Helps2bResponse, summary="Calculate HELPS2B", description="Assesses pain intensity", response_description="Pain intensity assessment", operation_id="helps2b")
